...
namespace CandidateManagement.Web.Controllers.Lookups
{
    ...
    {
        IContractStatusService service;
        ...
        public ActionResult ContractStatuses()
        {
        ...
        [AllowAnonymous]
        public JsonResult GetContractStatuses()
        {
        ...
        public string Create(string name, string description)
        {
            ...
            try
            {
                service.Create(new ContractStatus { Name = name, Description = description, ChangedBy = userid, CreatedBy = userid });
            }
            catch (Exception ex)
            {
        ...
        public string Update(int id, string name, string description)
        {
            ...
            try
            {
                ContractStatus model = service.GetById(id);
                model.Name = name;
