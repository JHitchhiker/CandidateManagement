...
namespace CandidateManagement.Web.Controllers.Lookups
{
    ...
    public class InterviewerController : Controller
    {
        ...
        [AllowAnonymous]
        public JsonResult GetInterviewers()
        {
        ...
        public string Create(string name, string description)
        {
            ...
            try
            {
                service.Create(new Interviewer { Name = name, Description = description, ChangedBy = userid, CreatedBy = userid });
            }
            catch (Exception ex)
            {
