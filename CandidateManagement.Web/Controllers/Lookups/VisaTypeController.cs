...
namespace CandidateManagement.Web.Controllers.Lookups
{
    ...
    {
        IVisaTypeService service;

        public VisaTypeController(IVisaTypeService service)
        {
        ...
        [AllowAnonymous]
        public JsonResult GetVisaTypes()
        {
        ...
        public string Create(string name, string description)
        {
            ...
            try
            {
                ...
                service.Create(new VisaType { Name = name, Description = description, CreatedBy = userid, ChangedBy = userid });
            }
            catch (Exception ex)
            {
