$(function () {
    ...
    var basicDemo = (function () {
        ...
        function _addEventListeners() {
            ...
            $('#outcome').on('select', function (event) {
                ...
                if (args) {
                    ...
                    if (val.toLowerCase() == 'signed up')
                    {
                        document.getElementById("lblsignup").hidden = false;
                        document.getElementById("signupdate").hidden = false;
                    }
                }
            });
        ...
        function _createElements() {
            ...
            //$('#interviewdate').jqxDateTimeInput({ placeHolder: "Null Value" });
            //$('#signupdate').jqxDateTimeInput({ placeHolder: "Null Value" });

            document.getElementById("lblsignup").hidden = true;
            document.getElementById("signupdate").hidden = true;
        };
        function _setValues() {
            ...
            signupdate = Date.parse($("#SignUpDate").val());
            ////datepicker
            $("#interviewdate").jqxDateTimeInput('setDate', interviewdate);
            $("#signupdate").jqxDateTimeInput('setDate', signupdate );
        };
        return {
            config: {
                dragArea: null
