    ...
    var basicDemo = (function () {
        ...
        function _addEventListeners() {
            ...
            $('#editsaveButton').click(function () {
                ...
                window.location.href='../Originator/Originators';
            });
            $('#confirmOK').click(function () {
                var data = { id: id };
                $.ajax({
                    url: '../Originator/Delete',
                    data: data,
                    type: "POST",
                    error: errfunc
                });
        ...
        function _createElements() {
            $("#grid").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    var gridTitle = "<div style='width: 100%; height: 100%; text-align: center;'><b>ORIGINATOR</b></div>";
