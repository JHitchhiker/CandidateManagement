    ...
    var source =
            {
                ...
                url: '../Report/GetOriginatorClosureRates',
                id: 'Id'
            };
    ...
    var basicDemo = (function () {
        ...
        function _createElements() {
            $("#grid").jqxDataTable(
            {
                ...
                columns: [
                    { text : 'Originator', datafield: 'Originator', width:'6.7%'},
                ...
                rendertoolbar: function (toolbar) {
                    var gridTitle = "<div style='width: 100%; height: 100%; text-align: center;'><b>ORIGINATOR CLOSURE RATES</b></div>";
