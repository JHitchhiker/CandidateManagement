        ...
        function _createElements() {
            $("#grid").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    var gridTitle = "<div style='width: 100%; height: 100%; text-align: center;'><b>CONTRACT STATUS</b></div>";
