    ...
    var source =
            {
                ...
                url: '../Report/GetOutcomeByOriginMonth',
                id: 'Id'
            };
        ...
        function _createElements() {
            $("#grid").jqxGrid(
            {
                ...
                columns: [
                            ...
                            { text: 'Outcome', datafield: 'Outcome', align: 'center', cellsalign: 'left' },
                ...
                rendertoolbar: function (toolbar) {
                    var gridTitle = "<div style='width: 100%; height: 100%; text-align: center;'><b>MONTHLY OUTCOMES BY SOURCE</b></div>";
